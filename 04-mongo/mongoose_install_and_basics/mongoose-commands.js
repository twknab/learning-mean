...
///////////////////
	...
	The mongo terminal, however, is less recommended. If you properly configure your Mongoose code, your 
	database and collections can be generated automatically upon the first write to the DB. For this 
	reason, it's recommended to build your databases through your Mongoose code rather than manually 
	create them in the terminal and try to connect.
	...
	*/
	...
	/////////
	//
	//	FIND ALL USERS BASED ON REQUIREMENT (FILTER)
	//
	/////////
